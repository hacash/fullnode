...
pub trait Readable : Field {
    ...
    fn from_readable(_: &[u8]) -> Self where Self: Sized { unimplemented!(); }
    fn build_readable(_: &[u8]) -> Ret<Self> where Self: Sized { unimplemented!(); }
