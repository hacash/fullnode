...
// Channel interest calculation moved to mint-core (`mint_core::interest`); keeps the old path usable.
pub use mint_core::interest::{both_interest, calculate_interest, calculate_interest_of_height};
