...
pub const ACTION_CODECS: &[ActionCodecBinding] = &[
    ...
    base::action_codec_binding!(ViewMessage),
    base::action_codec_binding!(ViewBlob),
    base::action_codec_binding!(ViewBlobSize),
    base::action_codec_binding!(EnvMessageNum),
    base::action_codec_binding!(EnvBlobNum),
