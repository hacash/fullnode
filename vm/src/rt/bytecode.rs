...
pub enum Bytecode {
    ...
    ________________6   = 0x06, // *@  call extend action
    ________________7   = 0x07, // *+  call extend action
    EXTENV              = 0x08,
    ...
    OR                  = 0x71, // a,b+   or
    EQ                  = 0x72, // a,b+   equal
    NEQ                 = 0x73, // a,b+   not equal
    LT                  = 0x74, // a,b+   less than
    GT                  = 0x75, // a,b+   great than
    LE                  = 0x76, // a,b+   less and eq
    GE                  = 0x77, // a,b+   great and eq
    NOT                 = 0x78, // a+   not
    ________________121 = 0x79,
    ________________122 = 0x7a,
    BSHR                = 0x7b, // a,b+   shr: >>
    BSHL                = 0x7c, // a,b+   shl: <<
    BXOR                = 0x7d, // a,b+   xor: ^
    BOR                 = 0x7e, // a,b+   or:  |
